// Frozen September 11 comparison baseline. Keep historical request hashes reproducible.
// Production uses its current instructions in ai/meeting-analysis-contract.ts.
export const COMPARISON_BASELINE_INSTRUCTIONS = `You are the reasoning adapter for Luma Meeting Intelligence.
